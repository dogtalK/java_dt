...
CREATE TABLE `salaryHistory` (
	...
	`sh_bo_type`	VARCHAR(20)	NOT NULL,
...
CREATE TABLE `attendance` (
	...
	`ad_st_time`	TIME	NULL,
	`ad_end_time`	TIME	NULL,
	`ad_ad_date`	DATE	NULL,
	`ad_at_num`	INT	NOT NULL,
